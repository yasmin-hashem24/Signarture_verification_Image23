...
class Model:
    ...
    def train(self, real_dir: str = "", forged_dir: str = "") -> None:
        self.real_dataset.extend(self.readDataset(real_dir))
        self.forged_dataset.extend(self.readDataset(forged_dir))
        ...
        self.HOG_features.extend(real_extracted_features + forged_extracted_features)
        ...
        self.HOG_labels.extend(HOG_labels_real + HOG_labels_forged)
